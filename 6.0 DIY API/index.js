...
app.delete("/jokes/:id",(req,res)=>{
  ...
  if(findIndex != -1){
    ...
    res.status(404).json({error : `Joke with ${id} not found. No Joke deleted`});
  }
});
...
app.delete("/all",(req,res)=>{
  if(masterKey === req.query.key){
    ...
    res.status(404).json({error : `No authorizationt to delete all the jokes`});
  }
});
